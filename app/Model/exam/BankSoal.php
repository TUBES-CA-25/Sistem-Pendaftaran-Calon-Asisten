...
class BankSoal extends Model {
    ...
    public function getAllBanks() {
        $query = "SELECT 
                  ...
                  GROUP BY b.id, b.nama, b.deskripsi, b.created_at, b.updated_at
     ...
     */
    public function save($nama, $deskripsi) {
        $sql = "INSERT INTO " . self::$table . " (nama, deskripsi) VALUES (?, ?)";
     ...
     */
    public function updateBank($id, $nama, $deskripsi) {
        $sql = "UPDATE " . self::$table . " SET nama = ?, deskripsi = ? WHERE id = ?";
        $stmt = self::getDB()->prepare($sql);
        $stmt->bindParam(1, $nama);
        $stmt->bindParam(2, $deskripsi);
