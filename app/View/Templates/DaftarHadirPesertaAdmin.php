            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === "success") {
                        showModal(response.message, "<?= BASE_URL ?>/Assets/gif/success.gif");
                        document.querySelector('a[data-page="daftarKehadiran"]').click();
                    } else {
                        console.log(response.message)
                        showModal(response.message, "<?= BASE_URL ?>/Assets/gif/failed.gif");
                    }
                },
            });
        });
        ...
        $("#saveDetailAbsensi").on("click", function (event) {
            ...
            $.ajax({
                ...
                error: function (xhr, status, error) {
                    ...
                    console.log(status)
                    showModal("Something went wrong. Please try again.", "<?= BASE_URL ?>/Assets/gif/failed.gif");
                }
            });
        });
