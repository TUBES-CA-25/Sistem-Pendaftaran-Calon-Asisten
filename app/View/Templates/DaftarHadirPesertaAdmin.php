            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === "success") {
                        showModal(response.message, "<?= PUBLIC_PATH ?>/Assets/gif/success.gif");
                        document.querySelector('a[data-page="daftarKehadiran"]').click();
                    } else {
                        console.log(response.message)
                        showModal(response.message, "<?= PUBLIC_PATH ?>/Assets/gif/failed.gif");
                    }
                },
            });
        });
        ...
        $("#saveDetailAbsensi").on("click", function (event) {
            ...
            $.ajax({
                ...
                error: function (xhr, status, error) {
                    ...
                    console.log(status)
                    showModal("Something went wrong. Please try again.", "<?= PUBLIC_PATH ?>/Assets/gif/failed.gif");
                }
            });
        });
