      ...
      $.ajax({
        ...
        success: function (response) {
          if (response.status === 'success') {
            showModal('soal berhasil ditambahkan!', '\u003c?= PUBLIC_PATH ?\u003e/Assets/gif/success.gif');
    ...
    $("#deleteButton").on("click", function () {
      ...
      showConfirm('Apakah Anda yakin ingin menghapus ruangan ini?', function () {
        $.ajax({
          ...
          success: function (response) {
            if (response.status === 'success') {
              showModal('Soal berhasil dihapus!', '\u003c?= PUBLIC_PATH ?\u003e/Assets/gif/success.gif');
              document.querySelector('a[data-page="tesTulis"]').click();
            } else {
              showModal('Soal berhasil dihapus!', '\u003c?= PUBLIC_PATH ?\u003e/Assets/gif/success.gif');
              document.querySelector('a[data-page="tesTulis"]').click();
        ...
        success: function (response) {
          try {
            ...
            if (jsonResponse.status === 'success') {
              showModal('Soal berhasil diupdate!', '\u003c?= PUBLIC_PATH ?\u003e/Assets/gif/success.gif');
              document.querySelector('a[data-page="tesTulis"]').click();
            } else {
              showModal('Soal gagal diupdate: ' + jsonResponse.message, '\u003c?= PUBLIC_PATH ?\u003e/Assets/gif/failed.gif');
              document.querySelector('a[data-page="tesTulis"]').click();
            }
          } catch (error) {
