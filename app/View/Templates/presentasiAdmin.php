    ...
    <script>
        $(document).ready(function () {
            ...
            $('#presentasiModal').on('show.bs.modal', function (event) {
                ...
                $('#downloadMakalahPresentasi').attr('data-download-url', makalah ? `\u003c?= RES_PATH ?\u003e/makalahUser/${makalah}` : '#');
                $('#downloadPptPresentasi').attr('data-download-url', ppt ? `\u003c?= RES_PATH ?\u003e/pptUser/${ppt}` : '#');
