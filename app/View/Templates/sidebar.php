...
<div class="sidebar" id="sidebar">
    ...
    <ul>
        ...
        <li>
            <a href="<?= APP_URL ?>/biodata" data-page="biodata">
                <i class="bx bxs-id-card"></i>
                <span class="nav-item">Lengkapi Biodata</span>
            </a>
        </li>
        <li>
            <a href="<?= APP_URL ?>/uploadBerkas" data-page="uploadBerkas">
                <i class="bx bx-file"></i>
                <span class="nav-item">Upload Berkas</span>
            </a>
        </li>
        <li>
            <a href="<?= APP_URL ?>/tesTulis" data-page="tesTulis">
                <i class="bx bx-task"></i>
                <span class="nav-item">Tes Tulis</span>
            </a>
        </li>
        <li>
            <a href="<?= APP_URL ?>/presentasi" data-page="presentasi">
