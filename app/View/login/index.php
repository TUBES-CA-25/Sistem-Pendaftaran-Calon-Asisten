...
<head>
    ...
    <link rel="stylesheet" href="<?= APP_URL ?>/Assets/Style/Styles1.css">
...
<body>
            ...
            <form id="loginForm">
                <div>
                    <div style="margin-bottom: 20px; text-align: center; position: relative; top: -10px;">
                        <img src="<?= APP_URL ?>/Assets/Img/umi.png" alt="logo fikom" class="logo"
                            style="margin-right: 10px; width: 80px;">
                        <img src="<?= APP_URL ?>/Assets/Img/fikom.png" alt="" class="logo"
                            style="margin-right: 10px; width: 80px;">
                        <img src="<?= APP_URL ?>/Assets/Img/iclabs.png" alt="" class="logo" style="width: 80px;">
                    </div>
                    ...
                    <div>
                        <div style="position: relative; width: 100%; margin-bottom: 15px;">
                            <img src="<?= APP_URL ?>/Assets/Img/idcard.svg" alt="ID Card Icon"
                        ...
                        <div style="position: relative; width: 100%; margin-bottom: 15px;">
                            <img src="<?= APP_URL ?>/Assets/Img/password.svg" alt="Lock Icon"
                                style="position: absolute; left: 10px; top: 50%; transform: translateY(-50%); width: 20px; height: 20px;">
            ...
            <form id="registerForm">
                <div>
                    ...
                    <div style="width: 100%; max-width: 400px; margin: auto; padding: 20px;">
                        ...
                        <div style="position: relative; width: 100%; margin-bottom: 15px;">
                            <img src="<?= APP_URL ?>/Assets/Img/profile.svg" alt="Profile Icon"
                                style="position: absolute; left: 10px; top: 50%; transform: translateY(-50%); width: 20px; height: 20px;">
                        ...
                        <div style="position: relative; width: 100%; margin-bottom: 15px;">
                            <img src="<?= APP_URL ?>/Assets/Img/password.svg" alt="Key Icon"
                                style="position: absolute; left: 10px; top: 50%; transform: translateY(-50%); width: 20px; height: 20px;">
    ...
    <script src="<?= APP_URL ?>/Assets/Script/Login/ScriptLogin.js"></script>
