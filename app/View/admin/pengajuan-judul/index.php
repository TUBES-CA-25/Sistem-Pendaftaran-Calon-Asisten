...
<div data-modal class="fixed inset-0 z-[1050] hidden items-center justify-center p-4 opacity-0 transition-opacity duration-200 ease-out data-[open]:opacity-100 bg-slate-900/50 backdrop-blur-sm" id="detailPengajuanModal" role="dialog" aria-hidden="true">
    ...
    <div class="relative w-full max-w-[500px] scale-95 transition-transform duration-200 ease-out [[data-open]_&]:scale-100">
        <div class="relative isolate w-full rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="border-t border-slate-100 bg-slate-50 px-6 py-4 rounded-b-2xl flex flex-col md:flex-row justify-center items-center gap-3">
                <button class="w-full md:w-auto px-5 py-2.5 bg-white border border-emerald-500 text-emerald-600 hover:bg-emerald-50 font-semibold text-sm rounded-xl transition shadow-sm flex items-center justify-center gap-2" id="btnModalAccept">
                    <i class="bi bi-check-circle-fill"></i> Berhasil Diterima
                </button>
                <button class="w-full md:w-auto px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white font-semibold text-sm rounded-xl transition shadow-md shadow-red-500/10 flex items-center justify-center gap-2" id="btnModalReject">
